    ...
    return sequelize.define(
        'Pokemon', 
        {
          pokemon_id: {
            ...
            autoIncrement: true,
            validate: {
              isInt: { msg: 'Utilisez uniquement des nombres entiers pour l\'identifiant des pokemons!' }
            }
          },
          pokemon_name: {
          ...
          picture: {
            ...
            allowNull: false,
            unique: {
              msg: 'Cette image existe dejà !'
            },
            validate: {
              isUrl: { msg: 'Utilisez une url valide pour l\'mage d\'un pokemon !' },
              notNull: { msg: 'L\'image d\'un pokemon est une propriete requise !' }
            }
          },
          types: {
            type: DataTypes.STRING,
